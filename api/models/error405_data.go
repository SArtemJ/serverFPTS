...
func (m *Error405Data) UnmarshalJSON(raw []byte) error {
	// AO0
	var aO0 Error405DataAllOf0
	if err := swag.ReadJSON(raw, &aO0); err != nil {
		return err
	}
	m.Error405DataAllOf0 = aO0
...
func (m Error405Data) MarshalJSON() ([]byte, error) {
	...
	aO0, err := swag.WriteJSON(m.Error405DataAllOf0)
	if err != nil {
		return nil, err
	}
...
func (m *Error405Data) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with Error405DataAllOf0
	if err := m.Error405DataAllOf0.Validate(formats); err != nil {
		res = append(res, err)
	}
